  ...
  return (
    ...
    >
      ...
      <div className="px-5 pb-5 pt-2 space-y-5 text-sm text-graphite border-t border-graphite/15">
        ...
        <Step n={6} title="Отпуск (если был)">
          Блок <strong>«Отпуск»</strong> под проектами: для Н1 и/или Н2 отметь галочку и введи
          открут за дни замены. Пул 5,5% от этой суммы: 40% вам, 60% замене (вычитается из итога
          справа). Нули в бюджете/лидах — можно вводить явно, если половина месяца пустая.
        </Step>

        <Step n={7} title="Смотри итог справа">
          <ul className="list-disc pl-5 mt-2 space-y-1 text-muted">
            <li>
            ...
            <li>
              <strong>Отпуск</strong> — минус 60% пула 5,5% от отпускного открута (если включён).
            </li>
            <li>
              <strong>Итого к выплате</strong> — мотивация минус отпуск, не больше 350 000 ₽ по
              мотивации.
            </li>
          </ul>
        </Step>
