  ...
  return (
    ...
    >
      ...
      <div className="px-5 pb-5 pt-2 space-y-5 text-sm text-graphite border-t border-graphite/15">
        ...
        <Step n={6} title="Отпуск и замещение">
          Блок <strong>«Отпуск»</strong> — два поля: открут, пока <strong>вы в отпуске</strong>{' '}
          (−60% пула 5,5%) и открут, пока <strong>вы замещали</strong> (+60% пула). Можно заполнить
          оба, если в месяце было и то, и другое.
        </Step>
