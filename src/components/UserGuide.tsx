    ...
    >
      ...
      <div className="px-5 pb-5 pt-2 space-y-5 text-sm text-graphite border-t border-graphite/15">
        ...
        <Step n={6} title="Отпуск (если был)">
          Блок <strong>«Отпуск»</strong> под проектами: одно поле — открут за время замены. Пул
          5,5% от этой суммы: 40% вам, 60% замене (вычитается из итога справа). Нули в
          бюджете/лидах — можно вводить явно, если половина месяца пустая.
        </Step>
